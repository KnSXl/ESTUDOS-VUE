<template>
    <!-- Introdução à Composition API Props e Emit -->

    <!-- Linha horizontal -->
    <hr>
    <!-- Título -->
    <h1>Aula 28 - Composition API Props e Emit</h1>
...
import AppButtonAula28 from '@/components/common/AppButtonAula28.vue'
...
export default {
    ...
    setup() {
        ...
        // Função para obter a atualização
